 ...
 */
function thoughtbuzz_alpha_regions_alter(&$regions, $theme) {
 ...
 */
function thoughtbuzz_alpha_zones_alter(&$zones, $theme) {
 ...
 */
function thoughtbuzz_alpha_preprocess_html(&$vars) {
 ...
 */
function thoughtbuzz_alpha_preprocess_comment(&$vars) {
 ...
 */
function thoughtbuzz_alpha_preprocess_zone(&$vars) {
 ...
 */
function thoughtbuzz_alpha_preprocess_region(&$vars) {
  if (alpha_library_active('omega_equalheights')) {
    if (!empty($vars['elements']['#data']['equal_height_container'])) {
      $vars['content_attributes_array']['class'][] = 'equal-height-container';
    }
    ...
    if (!empty($vars['elements']['#data']['equal_height_element'])) {
      $vars['attributes,_array']['class'][] = 'equal-height-element';
    }
  }
}
 ...
 */
function thoughtbuzz_alpha_preprocess_node(&$vars) {
  // Prepare the arrays to handle the classes and ids for the node container.
 ...
 */
function thoughtbuzz_alpha_process_region(&$vars) {
 ...
 */
function thoughtbuzz_alpha_process_zone(&$vars) {
  $theme = alpha_get_theme();
 ...
 */
function thoughtbuzz_alpha_preprocess_block(&$vars) {
  $theme = alpha_get_theme();
  ...
  $vars['block_description'] = "SOME TEST TEXT";
