...
To use these stylesheets, rename the files and thoughtbuzz with the name of your theme.
...
thoughtbuzz-alpha-default-narrow.css  
...
thoughtbuzz-alpha-default-normal.css
...
thoughtbuzz-alpha-default-wide.css
